...
class TahapPerencanaanOjtTimSks extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tahap_perencanaan_ojt_tim_skss', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('tahap_perencanaan_ojt_tim_skss');
    }
}
