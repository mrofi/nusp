...
class TahapPerencanaanPenyusunanDokumenNuap extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tahap_perencanaan_penyusunan_dokumen_nuaps', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('tahap_perencanaan_penyusunan_dokumen_nuaps');
    }
}
