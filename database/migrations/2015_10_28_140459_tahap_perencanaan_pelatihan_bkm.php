...
class TahapPerencanaanPelatihanBkm extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tahap_perencanaan_pelatihan_bkms', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('tahap_perencanaan_pelatihan_bkms');
    }
}
