...
Wilayah::create(['kode' => '167102', 'nama_wilayah' => 'Seberang Ulu I', 'tingkat' => '3_kec', 'induk' => '167102']);
...
$user86 =   User::create(['username' => 'ce1',  'password' => bcrypt(nusp_password('ce123')),  'nama_lengkap' => 'ce1',    'email' => 'ce1@nusp.dev']);
$user87 =   User::create(['username' => 'ce2',  'password' => bcrypt(nusp_password('ce123')),  'nama_lengkap' => 'ce2',    'email' => 'ce2@nusp.dev']);
$user88 =   User::create(['username' => 'ce3',  'password' => bcrypt(nusp_password('ce123')),  'nama_lengkap' => 'ce3',    'email' => 'ce3@nusp.dev']);
$user89 =   User::create(['username' => 'ce4',  'password' => bcrypt(nusp_password('ce123')),  'nama_lengkap' => 'ce4',    'email' => 'ce4@nusp.dev']);
$user90 =   User::create(['username' => 'ce5',  'password' => bcrypt(nusp_password('ce123')),  'nama_lengkap' => 'ce5',    'email' => 'ce5@nusp.dev']);
$user91 =   User::create(['username' => 'ce6',  'password' => bcrypt(nusp_password('ce123')),  'nama_lengkap' => 'ce6',    'email' => 'ce6@nusp.dev']);
$user92 =   User::create(['username' => 'ce7',  'password' => bcrypt(nusp_password('ce123')),  'nama_lengkap' => 'ce7',    'email' => 'ce7@nusp.dev']);
$user93 =   User::create(['username' => 'ce8',  'password' => bcrypt(nusp_password('ce123')),  'nama_lengkap' => 'ce8',    'email' => 'ce8@nusp.dev']);
$user94 =   User::create(['username' => 'ce9',  'password' => bcrypt(nusp_password('ce123')),  'nama_lengkap' => 'ce9',    'email' => 'ce9@nusp.dev']);
$user95 =   User::create(['username' => 'ce10', 'password' => bcrypt(nusp_password('ce123')),  'nama_lengkap' => 'ce10',   'email' => 'ce10@nusp.dev']);
$user96 =   User::create(['username' => 'ce11', 'password' => bcrypt(nusp_password('ce123')),  'nama_lengkap' => 'ce11',   'email' => 'ce11@nusp.dev']);
$user97 =   User::create(['username' => 'ce12', 'password' => bcrypt(nusp_password('ce123')),  'nama_lengkap' => 'ce12',   'email' => 'ce12@nusp.dev']);
$user98 =   User::create(['username' => 'ce13', 'password' => bcrypt(nusp_password('ce123')),  'nama_lengkap' => 'ce13',   'email' => 'ce13@nusp.dev']);
$user99 =   User::create(['username' => 'ce14', 'password' => bcrypt(nusp_password('ce123')),  'nama_lengkap' => 'ce14',   'email' => 'ce14@nusp.dev']);
$user100 =   User::create(['username' => 'ce15', 'password' => bcrypt(nusp_password('ce123')),  'nama_lengkap' => 'ce15',   'email' => 'ce15@nusp.dev']);
$user101 =   User::create(['username' => 'ce16', 'password' => bcrypt(nusp_password('ce123')),  'nama_lengkap' => 'ce16',   'email' => 'ce16@nusp.dev']);
$user102 =   User::create(['username' => 'ce17', 'password' => bcrypt(nusp_password('ce123')),  'nama_lengkap' => 'ce17',   'email' => 'ce17@nusp.dev']);
$user103 =   User::create(['username' => 'ce18', 'password' => bcrypt(nusp_password('ce123')),  'nama_lengkap' => 'ce18',   'email' => 'ce18@nusp.dev']);
$user104 =   User::create(['username' => 'ce19', 'password' => bcrypt(nusp_password('ce123')),  'nama_lengkap' => 'ce19',   'email' => 'ce19@nusp.dev']);
$user105 =   User::create(['username' => 'ce20', 'password' => bcrypt(nusp_password('ce123')),  'nama_lengkap' => 'ce20',   'email' => 'ce20@nusp.dev']);
