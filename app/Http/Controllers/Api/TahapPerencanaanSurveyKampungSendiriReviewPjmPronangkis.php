...
use App\TahapPerencanaanSurveyKampungSendiriReviewPjmPronangkis as Model;
use Illuminate\Http\Request;
use App\Http\Requests;
use App\Http\Controllers\ApiController;

class TahapPerencanaanSurveyKampungSendiriReviewPjmPronangkis extends ApiController
{
