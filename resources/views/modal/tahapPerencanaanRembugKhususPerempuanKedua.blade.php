...
@section('reportOnly.tahap2.rembug.prempuan2.modal.close.prop', 'data-toggle="modal" data-target="#modal-tahap-perencanaan"')
...
@section('reportOnly.tahap2.rembug.prempuan2.modal.close', 'Tutup')
