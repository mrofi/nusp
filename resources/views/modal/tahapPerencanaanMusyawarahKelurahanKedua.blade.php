...
@section('reportOnly.tahap2.musyawarah.kelurahan2.modal.close.prop', 'data-toggle="modal" data-target="#modal-report-tahap-perencanaan"')
...
@section('reportOnly.tahap2.musyawarah.kelurahan2.modal.close', 'Kembali')
