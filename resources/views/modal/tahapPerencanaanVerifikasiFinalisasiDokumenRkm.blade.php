...
@section('reportOnly.tahap2.verifikasi.finalisasi.rkm.modal.close.prop', 'data-toggle="modal" data-target="#modal-report-tahap-perencanaan"')
...
@section('reportOnly.tahap2.verifikasi.finalisasi.rkm.modal.close', 'Kembali')
