...
@section('reportOnly.tahap3.tahap-1.modal.close.prop', 'data-toggle="modal" data-target="#modal-tahap-konstruksi"')
...
@section('reportOnly.tahap3.tahap-1.modal.close', 'Tutup')
