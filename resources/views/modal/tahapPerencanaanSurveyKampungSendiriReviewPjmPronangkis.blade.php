...
@section('tahap2.survey.kampung.review.pjm.pronangkis.modal.form.action', nusp_asset('api/tahap-2-survey-kampung-sendiri-review-pjm-pronangkis'))
...
@section('reportOnly.tahap2.survey.kampung.review.pjm.pronangkis.modal.form.action', nusp_asset('api/tahap-2-survey-kampung-sendiri-review-pjm-pronangkis'))
