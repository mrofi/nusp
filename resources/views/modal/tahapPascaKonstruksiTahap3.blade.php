...
@section('reportOnly.tahap3.tahap-4.modal.close.prop', 'data-toggle="modal" data-target="#modal-report-tahap-konstruksi"')
...
@section('reportOnly.tahap3.tahap-4.modal.close', 'Kembali')
