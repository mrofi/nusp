...
@section('reportOnly.tahap2.pembentukan.tppi.modal.close.prop', 'data-toggle="modal" data-target="#modal-tahap-perencanaan"')
...
@section('reportOnly.tahap2.pembentukan.tppi.modal.close', 'Tutup')
