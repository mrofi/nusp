...
@section('tahap3.rembug.prempuan2.modal.close.prop', 'data-toggle="modal" data-target="#modal-tahap-konstruksi"')
@section('reportOnly.tahap3.rembug.prempuan2.modal.close.prop', 'data-toggle="modal" data-target="#modal-tahap-konstruksi"')
