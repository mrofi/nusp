...
@section('reportOnly.tahap1.sosialisasi.modal.close.prop', 'data-toggle="modal" data-target="#modal-report-tahap-persiapan"')
...
@section('reportOnly.tahap1.sosialisasi.modal.close', 'Kembali')
